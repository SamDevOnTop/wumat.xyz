...
function loadNotiLib()
	local notilib = {}
	function notilib:Notify(texts, timealive)
	   local uglynotis = Instance.new("ScreenGui")
	   local holdercum = Instance.new("Frame")
	   ...
	   uglynotis.Name = tostring(math.random())
	   uglynotis.Parent = game.CoreGui
 
	   holdercum.Name = "holder:cum:"
	   holdercum.Parent = uglynotis
	   holdercum.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
	   holdercum.BackgroundTransparency = 1.000
	   holdercum.Position = UDim2.new(0.995, 0, 0.985, 0)
	   holdercum.AnchorPoint = Vector2.new(1, 1)
	   holdercum.Size = UDim2.new(0, 0, 0, 0)
 
	   main.Name = "main"
	   main.Parent = holdercum
	   ...
	   top.Position = UDim2.new(0.5, 0, 0.138686135, 0)
	   ...
	   text.Position = UDim2.new(0.0384615399, 0, 0.313868612, 0)
	   ...
	   shadow1.Parent = holdercum
	   shadow1.AnchorPoint = Vector2.new(0.5, 0.5)
	   shadow1.BackgroundTransparency = 1.000
	   shadow1.Position = UDim2.new(0.5, 0, 0.521897793, 0)
	   shadow1.Size = UDim2.new(0, 0, 0, 0)
	   shadow1.ZIndex = 0
	   ...
	   shadow2.Parent = holdercum
	   shadow2.AnchorPoint = Vector2.new(0.5, 0.5)
	   shadow2.BackgroundTransparency = 1.000
	   shadow2.Position = UDim2.new(0.5, 0, 0.507299244, 0)
	   shadow2.Size = UDim2.new(0, 0, 0, 0)
	   shadow2.ZIndex = 0
	   ...
	   shadow3.Parent = holdercum
	   shadow3.AnchorPoint = Vector2.new(0.5, 0.5)
	   shadow3.BackgroundTransparency = 1.000
	   shadow3.Position = UDim2.new(0.5, 0, 0.543795645, 0)
	   shadow3.Size = UDim2.new(0, 0, 0, 0)
	   shadow3.ZIndex = 0
	   ...
	   UIAspectRatioConstraint.Parent = uglynotis
	   UIAspectRatioConstraint.AspectRatio = 1.834
 
	   game:GetService("TweenService"):Create(holdercum, TweenInfo.new(0.3), {Size = UDim2.new(0, 286, 0, 137)}):Play()
	   game:GetService("TweenService"):Create(main, TweenInfo.new(0.3), {Size = UDim2.new(1, 0, 1, 0)}):Play()
	   game:GetService("TweenService"):Create(top, TweenInfo.new(0.3), {Size = UDim2.new(0, 286, 0, 36)}):Play()
	   game:GetService("TweenService"):Create(title, TweenInfo.new(0.3), {Size = UDim2.new(1, 0, 1, 0)}):Play()
	   game:GetService("TweenService"):Create(text, TweenInfo.new(0.3), {Size = UDim2.new(0, 268, 0, 80)}):Play()
	   game:GetService("TweenService"):Create(shadow1, TweenInfo.new(0.3), {Size = UDim2.new(1, 5, 1, 5)}):Play()
	   game:GetService("TweenService"):Create(shadow2, TweenInfo.new(0.3), {Size = UDim2.new(1, 18, 1, 18)}):Play()
	   game:GetService("TweenService"):Create(shadow3, TweenInfo.new(0.3), {Size = UDim2.new(1, 10, 1, 10)}):Play()
	   wait(0.2)
	   text.Text = texts
	   wait(timealive)
	   game:GetService("TweenService"):Create(holdercum, TweenInfo.new(0.3), {Size = UDim2.new(0, 0, 0, 0)}):Play()
	   game:GetService("TweenService"):Create(main, TweenInfo.new(0.3), {Size = UDim2.new(0, 0, 0, 0)}):Play()
	   game:GetService("TweenService"):Create(top, TweenInfo.new(0.3), {Size = UDim2.new(0, 0, 0, 0)}):Play()
	   game:GetService("TweenService"):Create(title, TweenInfo.new(0.3), {Size = UDim2.new(0, 0, 0, 0)}):Play()
	   game:GetService("TweenService"):Create(text, TweenInfo.new(0.3), {Size = UDim2.new(0, 0, 0, 0)}):Play()
	   game:GetService("TweenService"):Create(shadow1, TweenInfo.new(0.3), {Size = UDim2.new(0, 0, 0, 0)}):Play()
	   game:GetService("TweenService"):Create(shadow2, TweenInfo.new(0.3), {Size = UDim2.new(0, 0, 0, 0)}):Play()
	   game:GetService("TweenService"):Create(shadow3, TweenInfo.new(0.3), {Size = UDim2.new(0, 0, 0, 0)}):Play()
	   wait(0.4)
	   uglynotis:Destroy()
	end
	return notilib
 end
 local noti = loadNotiLib()

function Hide()
	Debounce = true
	coroutine.wrap(function()
		noti:Notify("the interface has been hidden, unhide it by pressing rightshift!", 5)
	end)()
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if Settings.LoadingTitle ~= "Rayfield Interface Suite" then
		LoadingFrame.Version.Text = _G.ver
	end
